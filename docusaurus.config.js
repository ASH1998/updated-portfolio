...
const config = {
  title: "Ashutosh Mishra, Machine Learning Developer",
  tagline:
    "Machine Learning engineer interested in personal growth and tech trends. Cloud-native and open-source enthusiast.",
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          feedOptions: {
            type: "all",
            copyright: `Copyright © ${new Date().getFullYear()} Ashutosh Mishra`,
          },
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © 2012-${new Date().getFullYear()} Ashutosh Mishra.`,
      },
      // algolia: {
      //   appId: "5DLGGOZ8KA",
